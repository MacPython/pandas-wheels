...
be something like::
    ...
    wheel-uploader -r warehouse -u $CDN_URL -v -w ~/wheelhouse -t macosx pandas 0.18.1
    wheel-uploader -r warehouse -u $CDN_URL -v -w ~/wheelhouse -t manylinux1 pandas 0.18.1
...
* ``pandas`` is the root name of the wheel(s) to download / upload;
